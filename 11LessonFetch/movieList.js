 ...
 */
var REQUEST_URL = 'https://raw.githubusercontent.com/facebook/react-native/0.5-stable/docs/MoviesExample.json'
var MovieList = React.createClass({
  ...
  // 组件挂载完成-注意：ComponentDidMount将不会走此方法
  ...
  _renderSeparator:function (sectionID:number,rowID:number) {
    return(
      <View style={styles.header_separator} key={sectionID+rowID}></View>
    );
  }
});
